...
static_assert(round_down_pow2(0U) == 0U);
static_assert(round_down_pow2(1U) == 1U);
static_assert(round_down_pow2(2U) == 2U);
static_assert(round_down_pow2(3U) == 2U);
static_assert(round_down_pow2(0x1FABCU) == 0x10000U);

static_assert(round_up_pow2(0U) == 0U);
static_assert(round_up_pow2(1U) == 1U);
static_assert(round_up_pow2(2U) == 2U);
static_assert(round_up_pow2(3U) == 4U);
static_assert(round_up_pow2(0x1FABCU) == 0x20000U);
static_assert(round_up_pow2(0x1FFFFU) == 0x20000U);
